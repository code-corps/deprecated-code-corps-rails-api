Rails.configuration.x.reserved_routes = 
    %w(about account admin android api app apps blog bug bugs cache charter
    ...
    settings shop showcases sign-in sign-out signin signout
    signup sitemap skill_categories slug slugs spotlight stars status tag tags
    tasks team teams terms training trends trust tour twitter user_skill
    user_skills user users watching year)